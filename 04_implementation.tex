...
Prilikom izrade ovog završnog rada i razvijanja aplikacije koristeći se početnim kompletom Laravel Jetstream uočila sam stilsku nekonzistentnost u korisničkom sučelju pri prikazivanju profilne fotografije korisnika u navedenom Laravel \textit{first-party} paketu te sam zatim dala svoj doprinos. Bilo je potrebno \textit{forkati} izvorni repozitorij, učiniti potrebne izmjene u k\^odu na posebnoj grani te otvoriti \texttt{pull request} (dostupan na poveznici \url{https://github.com/laravel/jetstream/pull/1304}). Izmjene koje sam učinila su prihvaćene od strane Laravel tima te objavljene u sklopu Laravel Jetstream izdanja v3.1.3 koji je dostupan na poveznici \url{https://github.com/laravel/jetstream/releases/tag/v3.1.3} te je  na slici~\ref{fig:jetstreamCommits} prikazana povijest \textit{commita} za to izdanje.
\begin{figure}[H]
