...
\begin{lstlisting}[caption={LanguageContoller.php}, label=languageController]
<?php
...
\begin{figure}[H]
	...
	\centering
	\caption{\texttt{Gumb u navigacijskoj traci koji služi za promjenu trenutnog jezika aplikacije}}
